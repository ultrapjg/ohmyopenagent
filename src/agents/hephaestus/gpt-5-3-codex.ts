...
export function createHephaestusAgent(
  ...
  return {
    description:
      "Autonomous Deep Worker - goal-oriented execution with GPT 5.4 Codex. Explores thoroughly before acting, uses explore/librarian agents for comprehensive context, completes tasks end-to-end. Inspired by AmpCode deep mode. (Hephaestus - DS-OhMyCloseAgent)",
    mode: MODE,
    model,
    maxTokens: 32000,
    prompt,
